...
// PROPOSITIE-CONTRACT ⛔3 + §④ (niche-sites-upgrade-programma.md): de primaire nav toont DE VIER DINGEN,
// niet acht dienst-pagina's. Tot 24-07 stonden er acht in de dropdown; dat is dubbel zoveel als het
// contract toestaat en het maakt van een duidelijke propositie een menukaart.
//
...
// Ze vouwen onder "marketing die vanzelf loopt" (/automatisering) en blijven vanuit de FOOTER op elke
