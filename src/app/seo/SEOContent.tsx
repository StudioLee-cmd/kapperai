        ...
        >
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-2xl">
            <Image
              ...
              alt="SEO voor kappers — Google ranking dashboard op laptop"
              fill
              priority
          ...
          >
            <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-xl">
              <Image
                ...
                alt="Kapsalon eigenaar bekijkt SEO ranking-chart op tablet"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 1024px"
              />
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-12">
            ...
            >
              <Image
                ...
                alt="Google Maps listing voor een kapsalon op smartphone"
                fill
                className="object-cover"
            ...
            >
              ...
              <p className="text-foreground-accent leading-relaxed">Voor kappers gaat SEO niet over wereldwijde rankings — het gaat over lokaal vindbaar zijn in jouw stad of wijk. Onze SEO automatisering optimaliseert je Google Bedrijfsprofiel, lokale citations en publiceert maandelijks SEO-blogs gericht op zoektermen die jouw klanten daadwerkelijk gebruiken.</p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Link href="/social-media" className="group border border-[var(--card-border)] rounded-2xl p-6 bg-[var(--card-background)] hover:border-primary/40 transition-all">
                ...
                <p className="text-foreground-accent text-sm mb-3">Social signals versterken je local SEO — combineer voor maximale zichtbaarheid.</p>
                <span className="inline-flex items-center gap-1 text-primary text-sm font-semibold">Bekijk <BsArrowRight size={14} /></span>
              </Link>
          </div>
        </div>
