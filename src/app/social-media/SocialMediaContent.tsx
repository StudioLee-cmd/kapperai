        ...
        >
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-2xl">
            <Image
              ...
              alt="Instagram feed voor een kapsalon op smartphone"
              fill
              priority
          ...
          >
            <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-xl">
              <Image
                ...
                alt="Content planner op laptop met ring-light setup"
                fill
                className="object-cover"
                sizes="(max-width: 1024px) 100vw, 1024px"
              />
            ...
            <p className="text-center text-sm text-foreground-accent mt-3 max-w-2xl mx-auto">
              Wij plannen, ontwerpen en publiceren — jij focust op je kapsalon.
            </p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-12">
            ...
            >
              <Image
                ...
                alt="Instagram Reel voor een kapsalon met hair tools en haartrends"
                fill
                className="object-cover"
            ...
            >
              ...
              <p className="text-foreground-accent leading-relaxed">Voor kappers gaat social media om instroom: nieuwe klanten ontdekken je via Instagram of TikTok, kijken naar je werk, en boeken een afspraak. Onze social media planner zorgt dat je consistent zichtbaar bent met content die klanten daadwerkelijk overtuigt — zonder dat jij uren per week kwijt bent aan posts maken.</p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/chatbot" className="group border border-[var(--card-border)] rounded-2xl p-6 bg-[var(--card-background)] hover:border-primary/40 transition-all">
                ...
                <p className="text-foreground-accent text-sm mb-3">Vangt nieuwe leads op die via Instagram of TikTok naar je website komen.</p>
              ...
              <Link href="/seo" className="group border border-[var(--card-border)] rounded-2xl p-6 bg-[var(--card-background)] hover:border-primary/40 transition-all">
                <h3 className="text-lg font-bold mb-2 group-hover:text-primary transition-colors">SEO voor Kappers</h3>
                <p className="text-foreground-accent text-sm mb-3">Social media + SEO = volledige online dekking voor jouw kapsalon.</p>
                <span className="inline-flex items-center gap-1 text-primary text-sm font-semibold">Bekijk <BsArrowRight size={14} /></span>
              </Link>
