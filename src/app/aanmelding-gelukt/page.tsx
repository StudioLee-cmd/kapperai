            ...
            <Container className="flex-grow flex items-center justify-center py-24">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-12">
                        Gefeliciteerd! We zijn direct begonnen met het klaarmaken van jouw account. Nog één ding en we kunnen aan de slag: vul je salon-profiel in, dan werkt alles straks op jouw prijzen en behandelingen.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link
                            href="https://airs-app.vercel.app/vragenlijst?niche=kapper"
                        ...
                        >
                            Vul je salon-profiel in <BsArrowRight className="ml-2" />
                        </Link>
                    </div>
                </div>
            </Container>
